...
class UserMatcher:
    ...
    def find_by_username_normalized(self, username: str) -> Optional[Dict[str, Any]]:
        ...
        Catches cases like janewinters -> jane.winters@example.com
    ...
    def best_match(
        ...
        # (e.g. "jane.doe@example.com") over reconstructing from the
        # dot-stripped username ("janedoe@example.com") which never matches.
        guessed_email = ""
        if original_email:
        ...
        # Jamf local account "janewinters" -> Snipe-IT user "jane.winters@example.com"
